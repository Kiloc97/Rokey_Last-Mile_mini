...
bool custom_msgs__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // x_center
    ...
    ros_message->x_center = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // y_center
    ...
    assert(PyLong_Check(field));
    ros_message->y_center = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // distance
  ...
  {  // map_x
    ...
    assert(PyFloat_Check(field));
    ros_message->map_x = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_y
    ...
    assert(PyFloat_Check(field));
    ros_message->map_y = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_z
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_z");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->map_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // frame_id
...
PyObject * custom_msgs__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {  // x_center
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->x_center);
    {
  ...
  {  // y_center
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->y_center);
    {
  ...
  {  // map_z
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->map_z);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_z", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
