...
#include "rosidl_runtime_c/string.h"  // class_name, frame_id
#include "rosidl_runtime_c/string_functions.h"  // class_name, frame_id
  ...
  size_t current_alignment)
{
  ...
  // field.name map_z
  {
    size_t item_size = sizeof(ros_message->map_z);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name frame_id
